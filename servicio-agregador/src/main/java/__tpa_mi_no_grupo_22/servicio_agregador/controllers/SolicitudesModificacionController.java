...
@RestController()
@RequestMapping("/metamapa/solicitudes-modif")
public class SolicitudesModificacionController {
  @Autowired
  private ISolicitudesModificacionService solicitudesService;
  ...
  public ResponseEntity<SolicitudModificacionOutputDTO> crearSolicitud(@RequestBody @Valid SolicitudModificacionInputDTO solicitudModificacionInputDTO) {
    log.info("usuario en solicitud controller: " + solicitudModificacionInputDTO.getHecho().getUsuario());
    return ResponseEntity.ok(solicitudesService.crearSolicitud(solicitudModificacionInputDTO));
  }
  ...
  public ResponseEntity<List<SolicitudModificacionOutputDTO>> obtenerPendientes() {
  ...
  @GetMapping("{id}")
  public ResponseEntity<SolicitudModificacionOutputDTO> obtenerSolicitud(@PathVariable Long id) {
